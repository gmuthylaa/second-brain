    ...
    <div className="max-w-4xl mx-auto">
      <Card className="h-[calc(100vh-180px)] flex flex-col shadow-sm">
        <CardHeader>
          ...
          <p className="text-sm text-slate-500">Conversation is remembered</p>
        </CardHeader>

        <CardContent className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50">
          {messages.length === 0 && (
            <div className="text-center text-slate-500 py-12">
              Ask me anything about your notes or life. I will remember our conversation.
            </div>
          )}
        ...
        <div className="p-4 border-t bg-white">
          <div className="flex gap-3">
            <Textarea
              ...
              placeholder="Ask anything about your notes or life..."
